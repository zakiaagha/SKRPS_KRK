                  ...
                  <tbody>  
                    ...
                    <tr>
                      ...
                      <td style="border: none;">
                        ...
                        if ($_SESSION['role_id'] == 1) {
                          echo "<input type='text' class='form-control' id='app_nik' name='app_nik' autocomplete='off' value='".$app->app_certificate_no."' required>";
                        } else {                          
                    ...
                    <tr>
                      ...
                      <td style="border: none;">
                        <?php 
                        if ($_SESSION['role_id'] == 1) {
                          echo "<input type='text' class='form-control' id='app_nik' name='app_nik' autocomplete='off' value='".$app->app_pl_no."' required>";
                        } else {                          
                          echo $app->app_pl_no;
                        }?>
                      </td>
                    ...
                    <tr>
                      ...
                      <td style="border: none;">
                        <?php 
                        if ($_SESSION['role_id'] == 1) {
                          echo "<input type='text' class='form-control' id='app_nik' name='app_nik' autocomplete='off' value='".$app->app_imb_no."' required>";
                        } else {                          
                          echo $app->app_imb_no;
                        }?>
                      </td>
                  ...
                  <tbody>  
                    <tr>
                      ...
                      <td style="border: none;">
                        <?php 
                        if ($_SESSION['role_id'] == 1) {
                          echo "<input type='text' class='form-control' id='app_nik' name='app_nik' autocomplete='off' value='".$app->app_allotment_perpres."' required>";
                        } else {                          
                    ...
                    <tr>
                      ...
                      <td style="border: none;">
                        <?php 
                        if ($_SESSION['role_id'] == 1) {
                          echo "<input type='text' class='form-control' id='app_nik' name='app_nik' autocomplete='off' value='".$app->app_allotment_prov."' required>";
                        } else {                          
                    ...
                    <tr>
                      ...
                      <td style="border: none;">
                        <?php 
                        if ($_SESSION['role_id'] == 1) {
                          echo "<input type='text' class='form-control' id='app_nik' name='app_nik' autocomplete='off' value='".$app->app_building_allotment."' required>";
                        } else {                          
                    ...
                    <tr>
                      ...
                      <td style="border: none;">
                        <?php 
                        if ($_SESSION['role_id'] == 1) {
                          echo "<input type='text' class='form-control' id='app_nik' name='app_nik' autocomplete='off' value='".$app->app_max_building_height."' required>";
                        } else {                          
                    ...
                    <tr>
                      ...
                      <td style="border: none;">
                        <?php 
                        if ($_SESSION['role_id'] == 1) {
                          echo "<input type='text' class='form-control' id='app_nik' name='app_nik' autocomplete='off' value='".$app->app_no_of_floors."' required>";
                        } else {                          
                    ...
                    <tr>
                      ...
                      <td style="border: none;">
                        <?php 
                        if ($_SESSION['role_id'] == 1) {
                          echo "<input type='text' class='form-control' id='app_nik' name='app_nik' autocomplete='off' value='".$app->app_min_gsb_front."' required>";
                        } else {                          
                    ...
                    <tr>
                      ...
                      <td style="border: none;">
                        <?php 
                        if ($_SESSION['role_id'] == 1) {
                          echo "<input type='text' class='form-control' id='app_nik' name='app_nik' autocomplete='off' value='".$app->app_min_gsb_right_side."' required>";
                        } else {                          
                    ...
                    <tr>
                      ...
                      <td style="border: none;">
                        <?php 
                        if ($_SESSION['role_id'] == 1) {
                          echo "<input type='text' class='form-control' id='app_nik' name='app_nik' autocomplete='off' value='".$app->app_min_gsb_left_side."' required>";
                        } else {                          
                    ...
                    <tr>
                      ...
                      <td style="border: none;">
                        <?php 
                        if ($_SESSION['role_id'] == 1) {
                          echo "<input type='text' class='form-control' id='app_nik' name='app_nik' autocomplete='off' value='".$app->app_min_gsb_back."' required>";
                        } else {                          
                    ...
                    <tr>
                      ...
                      <td style="border: none;">
                        <?php 
                        if ($_SESSION['role_id'] == 1) {
                          echo "<input type='text' class='form-control' id='app_nik' name='app_nik' autocomplete='off' value='".$eks->app_min_gsp."' required>";
                        } else {                          
                    ...
                    <tr>
                      ...
                      <td style="border: none;">
                        <?php 
                        if ($_SESSION['role_id'] == 1) {
                          echo "<input type='text' class='form-control' id='app_nik' name='app_nik' autocomplete='off' value='".$eks->app_max_kdb."' required>";
                        } else {                          
                    ...
                    <tr>
                      ...
                      <td style="border: none;">
                        <?php 
                        if ($_SESSION['role_id'] == 1) {
                          echo "<input type='text' class='form-control' id='app_nik' name='app_nik' autocomplete='off' value='".$eks->app_max_klb."' required>";
                        } else {                          
                    ...
                    <tr>
                      ...
                      <td style="border: none;">
                        <?php 
                        if ($_SESSION['role_id'] == 1) {
                          echo "<input type='text' class='form-control' id='app_nik' name='app_nik' autocomplete='off' value='".$app->app_min_kdh."' required>";
                        } else {                          
                    ...
                    <tr>
                      ...
                      <td style="border: none;">
                        <?php 
                        if ($_SESSION['role_id'] == 1) {
                          echo "<input type='text' class='form-control' id='app_nik' name='app_nik' autocomplete='off' value='".$app->app_max_ktb."' required>";
                        } else {                          
                    ...
                    <tr>
                      ...
                      <td style="border: none;">
                        <?php 
                        if ($_SESSION['role_id'] == 1) {
                          echo "<input type='text' class='form-control' id='app_nik' name='app_nik' autocomplete='off' value='".$app->app_row."' required>";
                        } else {                          
                          echo $app->app_row;
                        }?>
                      </td>
